...
mod game_tests {
    ...
    async fn get_winner_tests() {
...

        {
            ...
            let bob_hand = table.find_player_by_id_mut(&bob_address_encoded).unwrap();
            bob_hand.points = 20;

            let alice_hand = table.find_player_by_id_mut(&alice_address_encoded).unwrap();
            alice_hand.points = 21;
